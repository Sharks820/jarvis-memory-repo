...
class TestCostTracker:
    ...
    def test_cost_tracker_log_and_summary(self, cost_tracker: CostTracker) -> None:
        ...
        cost_tracker.log(
            "claude-sonnet-4-5-20250929", "anthropic", 1000, 500, cost_usd=0.01
        )
        cost_tracker.log(
            "claude-sonnet-4-5-20250929", "anthropic", 2000, 1000, cost_usd=0.02
        )
        ...
        sonnet = next(
            m for m in summary["models"] if m["model"] == "claude-sonnet-4-5-20250929"
        )
    ...
    def test_cost_tracker_summary_respects_days_filter(
...
class TestModelGateway:
    ...
    def test_gateway_anthropic_call(
    ...
    @patch("jarvis_engine.gateway.models.OllamaClient")
    @patch("jarvis_engine.gateway.models.Anthropic")
    def test_gateway_fallback_on_api_error(
        self,
    ...
    @patch("jarvis_engine.gateway.models.OllamaClient")
    @patch("jarvis_engine.gateway.models.Anthropic")
    def test_gateway_local_only_mode(
        self,
        mock_anthropic_cls: MagicMock,
        mock_ollama_cls: MagicMock,
        mock_cli: MagicMock,
...
class TestCallOpenaiCompat:
    ...
    @patch.dict(
        "os.environ",
        {"GROQ_API_KEY": "groq-test-key", "MISTRAL_API_KEY": "", "ZAI_API_KEY": ""},
    )
    @patch("jarvis_engine.gateway.models.OllamaClient")
    @patch("jarvis_engine.gateway.models.Anthropic")
    def test_successful_groq_call(
        self, mock_anthropic_cls: MagicMock, mock_ollama_cls: MagicMock
    ) -> None:
    ...
    @patch.dict(
        "os.environ",
        {"GROQ_API_KEY": "", "MISTRAL_API_KEY": "mistral-test-key", "ZAI_API_KEY": ""},
    )
    @patch("jarvis_engine.gateway.models.OllamaClient")
    @patch("jarvis_engine.gateway.models.Anthropic")
    def test_successful_mistral_call(
        self, mock_anthropic_cls: MagicMock, mock_ollama_cls: MagicMock
    ) -> None:
    ...
    @patch.dict(
        "os.environ",
        {"GROQ_API_KEY": "", "MISTRAL_API_KEY": "", "ZAI_API_KEY": "zai-test-key"},
    )
    @patch("jarvis_engine.gateway.models.OllamaClient")
    @patch("jarvis_engine.gateway.models.Anthropic")
    def test_successful_zai_call(
        self, mock_anthropic_cls: MagicMock, mock_ollama_cls: MagicMock
    ) -> None:
    ...
    @patch("jarvis_engine.gateway.models.OllamaClient")
    @patch("jarvis_engine.gateway.models.Anthropic")
    def test_model_alias_resolved_to_api_model(
        self, mock_anthropic_cls: MagicMock, mock_ollama_cls: MagicMock
    ) -> None:
...
class TestResolveProvider:
    ...
    @patch("jarvis_engine.gateway.models.OllamaClient")
    @patch("jarvis_engine.gateway.models.Anthropic")
    def test_claude_model_routes_to_anthropic(
        self, mock_anthropic_cls: MagicMock, mock_ollama_cls: MagicMock
    ) -> None:
    ...
    @patch("jarvis_engine.gateway.models.OllamaClient")
    @patch("jarvis_engine.gateway.models.Anthropic")
    def test_claude_without_key_falls_to_ollama(
        self, mock_anthropic_cls: MagicMock, mock_ollama_cls: MagicMock
    ) -> None:
    ...
    @patch.dict(
        "os.environ",
        {"GROQ_API_KEY": "groq-key", "MISTRAL_API_KEY": "", "ZAI_API_KEY": ""},
    )
    @patch("jarvis_engine.gateway.models.OllamaClient")
    @patch("jarvis_engine.gateway.models.Anthropic")
    def test_groq_model_routes_to_cloud(
        self, mock_anthropic_cls: MagicMock, mock_ollama_cls: MagicMock
    ) -> None:
    ...
    @patch.dict(
        "os.environ",
        {"GROQ_API_KEY": "", "MISTRAL_API_KEY": "mistral-key", "ZAI_API_KEY": ""},
    )
    @patch("jarvis_engine.gateway.models.OllamaClient")
    @patch("jarvis_engine.gateway.models.Anthropic")
    def test_mistral_model_routes_to_cloud(
        self, mock_anthropic_cls: MagicMock, mock_ollama_cls: MagicMock
    ) -> None:
    ...
    @patch.dict(
        "os.environ",
        {"GROQ_API_KEY": "", "MISTRAL_API_KEY": "", "ZAI_API_KEY": "zai-key"},
    )
    @patch("jarvis_engine.gateway.models.OllamaClient")
    @patch("jarvis_engine.gateway.models.Anthropic")
    def test_zai_model_routes_to_cloud(
        self, mock_anthropic_cls: MagicMock, mock_ollama_cls: MagicMock
    ) -> None:
    ...
    @patch("jarvis_engine.gateway.models.OllamaClient")
    @patch("jarvis_engine.gateway.models.Anthropic")
    def test_cloud_model_without_key_falls_to_ollama(
        self, mock_anthropic_cls: MagicMock, mock_ollama_cls: MagicMock
    ) -> None:
    ...
    @patch("jarvis_engine.gateway.models.OllamaClient")
    @patch("jarvis_engine.gateway.models.Anthropic")
    def test_unknown_model_routes_to_ollama(
        self, mock_anthropic_cls: MagicMock, mock_ollama_cls: MagicMock
    ) -> None:
...
class TestBestCloudModel:
    ...
    @patch.dict(
        "os.environ",
        {"GROQ_API_KEY": "key", "MISTRAL_API_KEY": "key", "ZAI_API_KEY": "key"},
    )
    @patch("jarvis_engine.gateway.models.OllamaClient")
    @patch("jarvis_engine.gateway.models.Anthropic")
    def test_groq_is_highest_priority(
        self, mock_anthropic_cls: MagicMock, mock_ollama_cls: MagicMock
    ) -> None:
    ...
    @patch.dict(
        "os.environ",
        {"GROQ_API_KEY": "", "MISTRAL_API_KEY": "key", "ZAI_API_KEY": "key"},
    )
    @patch("jarvis_engine.gateway.models.OllamaClient")
    @patch("jarvis_engine.gateway.models.Anthropic")
    def test_mistral_when_no_groq(
        self, mock_anthropic_cls: MagicMock, mock_ollama_cls: MagicMock
    ) -> None:
    ...
    @patch.dict(
        "os.environ", {"GROQ_API_KEY": "", "MISTRAL_API_KEY": "", "ZAI_API_KEY": "key"}
    )
    @patch("jarvis_engine.gateway.models.OllamaClient")
    @patch("jarvis_engine.gateway.models.Anthropic")
    def test_zai_when_no_groq_or_mistral(
        self, mock_anthropic_cls: MagicMock, mock_ollama_cls: MagicMock
    ) -> None:
    ...
    @patch("jarvis_engine.gateway.models.OllamaClient")
    @patch("jarvis_engine.gateway.models.Anthropic")
    def test_no_cloud_keys_returns_none(
        self, mock_anthropic_cls: MagicMock, mock_ollama_cls: MagicMock
    ) -> None:
...
class TestFallbackChain:
    ...
    @patch("jarvis_engine.gateway.models.OllamaClient")
    @patch("jarvis_engine.gateway.models.Anthropic")
    def test_anthropic_fails_groq_succeeds(
        self, mock_anthropic_cls: MagicMock, mock_ollama_cls: MagicMock
    ) -> None:
    ...
    @patch("jarvis_engine.gateway.models.OllamaClient")
    @patch("jarvis_engine.gateway.models.Anthropic")
    def test_all_cloud_fails_ollama_fallback(
        self,
        mock_anthropic_cls: MagicMock,
        mock_ollama_cls: MagicMock,
        mock_cli: MagicMock,
    ...
    @patch.dict(
        "os.environ",
        {"GROQ_API_KEY": "key", "MISTRAL_API_KEY": "key", "ZAI_API_KEY": ""},
    )
    @patch("jarvis_engine.gateway.models.OllamaClient")
    @patch("jarvis_engine.gateway.models.Anthropic")
...
class TestHealthChecks:
    ...
    @patch("jarvis_engine.gateway.models.OllamaClient")
    @patch("jarvis_engine.gateway.models.Anthropic")
    def test_check_ollama_no_package(
        self, mock_anthropic_cls: MagicMock, mock_ollama_cls: MagicMock
    ) -> None:
    ...
    @patch("jarvis_engine.gateway.models.OllamaClient")
    @patch("jarvis_engine.gateway.models.Anthropic")
    def test_check_anthropic_without_key(
        self, mock_anthropic_cls: MagicMock, mock_ollama_cls: MagicMock
    ) -> None:
    ...
    @patch.dict(
        "os.environ", {"GROQ_API_KEY": "gk", "MISTRAL_API_KEY": "", "ZAI_API_KEY": "zk"}
    )
    @patch("jarvis_engine.gateway.models.OllamaClient")
    @patch("jarvis_engine.gateway.models.Anthropic")
    def test_check_cloud_returns_configured_providers(
        self, mock_anthropic_cls: MagicMock, mock_ollama_cls: MagicMock
    ) -> None:
...
class TestAvailableProviders:
    ...
    @patch.dict(
        "os.environ", {"GROQ_API_KEY": "gk", "MISTRAL_API_KEY": "", "ZAI_API_KEY": ""}
    )
    @patch("jarvis_engine.gateway.models._HAS_OLLAMA", True)
    @patch("jarvis_engine.gateway.models.OllamaClient")
    @patch("jarvis_engine.gateway.models.Anthropic")
    ...
    @patch("jarvis_engine.gateway.models.OllamaClient")
    @patch("jarvis_engine.gateway.models.Anthropic")
    def test_no_providers_when_ollama_down(
        self,
        mock_anthropic_cls: MagicMock,
        mock_ollama_cls: MagicMock,
        mock_cli: MagicMock,
    ...
    @patch.dict(
        "os.environ",
        {"GROQ_API_KEY": "gk", "MISTRAL_API_KEY": "mk", "ZAI_API_KEY": "zk"},
    )
    @patch("jarvis_engine.gateway.models._HAS_OLLAMA", True)
    @patch("jarvis_engine.gateway.models.OllamaClient")
    @patch("jarvis_engine.gateway.models.Anthropic")
    def test_all_cloud_keys_present(
        self, mock_anthropic_cls: MagicMock, mock_ollama_cls: MagicMock
    ) -> None:
...
class TestGatewayLifecycle:
    ...
    @patch("jarvis_engine.gateway.models.OllamaClient")
    @patch("jarvis_engine.gateway.models.Anthropic")
    def test_context_manager_returns_gateway(
        self, mock_anthropic_cls: MagicMock, mock_ollama_cls: MagicMock
    ) -> None:
...
class TestCloudCompleteIntegration:
    ...
    @patch("jarvis_engine.gateway.models.OllamaClient")
    @patch("jarvis_engine.gateway.models.Anthropic")
    def test_complete_dispatches_to_groq(
        self, mock_anthropic_cls: MagicMock, mock_ollama_cls: MagicMock
    ) -> None:
    ...
    @patch("jarvis_engine.gateway.models.OllamaClient")
    @patch("jarvis_engine.gateway.models.Anthropic")
    def test_init_with_explicit_cloud_keys(
        self, mock_anthropic_cls: MagicMock, mock_ollama_cls: MagicMock
    ) -> None:
        """ModelGateway accepts explicit cloud API keys via constructor."""
        gw = ModelGateway(
            groq_api_key="explicit-groq", mistral_api_key="explicit-mistral"
        )

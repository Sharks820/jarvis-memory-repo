...
class DataRoutesMixin:
    ...
    def _handle_post_ingest(self: MobileRouteHandlerProtocol) -> None:
    ...
    def _handle_post_feedback(self: MobileRouteHandlerProtocol) -> None:
    ...
    def _handle_get_activity(self: MobileRouteHandlerProtocol) -> None:

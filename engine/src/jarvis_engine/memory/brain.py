...
_HASH_MAP_RECENT_LIMIT = 1200  # keep only the N most recent entries after prune
...
def _update_index(
    ...
    if len(hash_map) > _HASH_MAP_MAX_ENTRIES:
        recent = _load_records(root, limit=_HASH_MAP_RECENT_LIMIT)
        keep = {
